...
import {BoldButton, ItalicButton, UnderlineButton, LinkButton, BLOCKS} from '@nti/web-editor';
	...
	return (
		<div className={cx('inline-format')}>
			<div className={cx('styles')}>
				<BoldButton {...buttonProps} shouldDisableForState={shouldDisableForState} />
				<ItalicButton {...buttonProps} shouldDisableForState={shouldDisableForState} />
				<UnderlineButton {...buttonProps} shouldDisableForState={shouldDisableForState} />
			</div>
