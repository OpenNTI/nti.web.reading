...
export default function CodeEditor (props) {
	...
	const {block, blockProps: {editorState, setBlockDataImmediately: setBlockData, setReadOnly}} = props;
	...
	return (
		<CustomBlock {...props} className={cx('code-block')}>
			...
			<NestedEditorWrapper tabIndex="0" onBlur={onBlur} onFocus={onFocus} onClick={focus}>
				<Input.TextArea
